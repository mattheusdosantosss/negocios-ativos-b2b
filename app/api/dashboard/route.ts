...
import { getWonAggregateCached, getCloseTimeCached, getMonthGoalCached } from "@/lib/dashboardCards";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const [owners, deals, checkoutDeals, won, closeRaw, goalRaw, tasksRaw] = await Promise.all([
      fetchAllOwners(),
      dealsP,
