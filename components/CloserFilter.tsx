  ...
  return (
    <div className="flex flex-col">
      ...
      <select
        ...
        className="w-full sm:w-[190px] rounded-lg border border-psa-line bg-psa-surface px-3 py-2 text-sm text-psa-ink focus:outline-none focus:border-psa-blue focus:ring-2 focus:ring-psa-blue/10"
      >
